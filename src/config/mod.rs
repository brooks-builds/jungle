...
pub struct Config {
    ...
    pub jump_force: f32,
    pub ladder_margin: f32,
    #[serde(with = "crate::config::serde_color")]
    pub ladder_rung_color: Color,
    pub ladder_rung_height: f32,
    pub ladder_rung_spacing: f32,
    pub ladder_width: f32,
...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            jump_force: 1.0,
            ladder_margin: 10.0,
            ladder_rung_color: Color::from_rgb(138, 98, 95),
            ladder_rung_height: 5.0,
            ladder_rung_spacing: 3.0,
            ladder_width: 100.0,
